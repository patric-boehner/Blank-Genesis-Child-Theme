...
if ( ! function_exists( 'cf_register_cpt_events' ) ) {

   // Register Services post type
   add_action( 'init', 'cf_register_cpt_events', 0 );

   function cf_register_cpt_events() {
      ...
      $args = array(
         ...
         'menu_position'       => null, // After posts
			'menu_icon'				 => 'dashicons-calendar', //dashicons
...
function pb_cp_name_notices( $messages ) {
   ...
   $messages['events'] = array(
      ...
      5  => isset( $_GET['revision'] ) ? sprintf( __( 'events restored to revision from %s', 'core-functionality' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
